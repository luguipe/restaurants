...
//                         </li>
//                         <li className="nav-item">
//                             <a className="nav-link" href="./users/signup">Signup</a>
//                         </li>
//                         <li className="nav-item">
            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link href="/users/signin" className="nav-link">Signin</Link>
                        </li>
                        <li className="nav-item">
                            <Link href="/users/signup" className="nav-link">Signup</Link>
                        </li>
                        <li className="nav-item">
